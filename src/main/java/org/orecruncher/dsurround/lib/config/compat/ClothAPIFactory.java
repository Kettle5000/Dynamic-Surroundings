...
public class ClothAPIFactory extends AbstractConfigScreenFactory {
    ...
    private static final ResourceLocation[] BACKGROUNDS = {
            java.util.Objects.requireNonNull(ResourceLocation.tryParse("minecraft:textures/block/cobblestone.png")),
            java.util.Objects.requireNonNull(ResourceLocation.tryParse("minecraft:textures/block/bedrock.png")),
            java.util.Objects.requireNonNull(ResourceLocation.tryParse("minecraft:textures/block/bricks.png")),
            java.util.Objects.requireNonNull(ResourceLocation.tryParse("minecraft:textures/block/sandstone.png")),
            java.util.Objects.requireNonNull(ResourceLocation.tryParse("minecraft:textures/block/stone.png")),
            java.util.Objects.requireNonNull(ResourceLocation.tryParse("minecraft:textures/block/oak_planks.png")),
            java.util.Objects.requireNonNull(ResourceLocation.tryParse("minecraft:textures/block/gilded_blackstone.png")),
            java.util.Objects.requireNonNull(ResourceLocation.tryParse("minecraft:textures/block/dirt.png"))
    };
