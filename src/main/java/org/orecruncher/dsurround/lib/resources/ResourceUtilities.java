...
public final class ResourceUtilities {
    ...
    public Collection<TagFile> findClientTagFiles(TagKey<?> tagKey) {
        ...
        var registryKey = tagKey.registry().location();
        var tagDir = "tags/" + (registryKey.getNamespace().equals("minecraft") ? registryKey.getPath() : registryKey.getNamespace() + "/" + registryKey.getPath());
